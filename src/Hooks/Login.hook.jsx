...
import "./Css/LoginHook.css"
import { GoogleLogin } from '@react-oauth/google';

const LoginHook = ({ paramName, paramEmail, paramNumber, paramPassword, paramOtherParams, emailGoogleHeight, emailGoogleColor, paramHeading, paramSubHeading }) => {
  ...
  useEffect(() => {
    if (paramEmail == null || paramName == null || paramNumber == null || paramPassword == null) {
      paramEmail = "flex";
      paramName = "flex";
      paramNumber = "flex";
      paramPassword = "flex";
    ...
    <>
      ...
      <main className='login-main' >
        ...
        <div className="regiistration-area" style={{ backgroundColor: emailGoogleColor, height: emailGoogleHeight }}>
          <form action="submit" className='email-registration'>
